...
const milestones = [
    ...
    { year: "2020", title: "Built My First Website 🌐", description: "Created a personal portfolio website to showcase my projects.", bg: '#E1F5FE', icons: ['🌐', '🖥️', '👨‍💻'] },
    ...
    { year: "2021", title: "Contributed to Open Source 👐", description: "Made my first contributions to open-source projects on GitHub.", bg: '#FFF3E0', icons: ['👐', '📈', '🖥️'] },
    { year: "2021", title: "Explored Back-end Development 🖧", description: "Learned Node.js and built my first REST API.", bg: '#F0F4C3', icons: ['🖧', '📡', '💾'] },
    { year: "2022", title: "Improved My Algorithms & Data Structures 📊", description: "Practiced on LeetCode and HackerRank to strengthen my problem-solving skills.", bg: '#F3E5F5', icons: ['📊', '🖥️', '📚'] },
    { year: "2022", title: "Attended Tech Conferences 📅", description: "Participated in local tech meetups and online webinars.", bg: '#FFF3E0', icons: ['📅', '🎤', '🖥️'] },
    { year: "2023", title: "First Major Project 🏘️", description: "Developed the Next Door Helpers app.", bg: '#E8F5E9', icons: ['🏘️', '👫', '🤝'] },
    { year: "2023", title: "Participated MSU Hackathon 🤖", description: "Worked with a team to develop an AI-driven educational tool.", bg: '#FFF3E0', icons: ['🤖', '🧠', '🎓'] },
